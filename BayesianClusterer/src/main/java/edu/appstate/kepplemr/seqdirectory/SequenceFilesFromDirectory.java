package edu.appstate.kepplemr.seqdirectory;
  ...
  */
  ...
  private int runMapReduce(Path input, Path output) throws IOException, ClassNotFoundException, InterruptedException {
    ...
    // When packaging with maven-assembly, included JARs can overwrite the proper conf settings; reset them. 
 	jobConfig.set("fs.hdfs.impl", org.apache.hadoop.hdfs.DistributedFileSystem.class.getName());
 	jobConfig.set("fs.file.impl", org.apache.hadoop.fs.LocalFileSystem.class.getName());
